...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        center1 = self.circle.center
        center2 = other_circle_changer.circle.center
        new_center = center1.halfway_to(center2)
        radius = center2.get_distance_from(center1)/2
        colors = self.colors + other_circle_changer.colors
        return CircleChanger(new_center.x, new_center.y, radius, "red", colors)
